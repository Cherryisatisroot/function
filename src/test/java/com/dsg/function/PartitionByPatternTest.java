...
public class PartitionByPatternTest {
    ...
    public void test1() {
        ...
        Assert.assertEquals(true, 4 == err1.length);
        ...
        Assert.assertEquals(true, 2 == normal.length);

        Integer[] type1 = autoPartition.calculateRange("1", "45");
        Assert.assertEquals(true, 1 == type1.length);
        ...
        Assert.assertEquals(true, 4 == type3.length);
    }
