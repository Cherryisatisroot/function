 ...
 * 1.设置相关参数
 * 2.调用初始化方法
 * 3.单参数调用calculate(String str)，双参数调用calculateRange(String str1, String str2)
 * 4.返回值为对应的分区值
 */

public class AutoPartitionByLongTest {

    private AutoPartitionByLong initPartition(String mapFile, Integer defaultNode, Boolean isSetNode) {
